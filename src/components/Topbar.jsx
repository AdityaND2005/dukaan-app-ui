export const Topbar = ()=>{
    return (
        <div className="border-b border-black-100 sm:pl-64">
            <div className="grid grid-cols-3 items-center gap-4 h-16">
                <div className="flex items-center w-80">
                    <div className="text-xl font-medium">Payouts</div>
                    <div className="pl-4"><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-4">
                    <path stroke-linecap="round" stroke-linejoin="round" d="M9.879 7.519c1.171-1.025 3.071-1.025 4.242 0 1.172 1.025 1.172 2.687 0 3.712-.203.179-.43.326-.67.442-.745.361-1.45.999-1.45 1.827v.75M21 12a9 9 0 1 1-18 0 9 9 0 0 1 18 0Zm-9 5.25h.008v.008H12v-.008Z" />
                    </svg>
                    </div>
                    <div className="text-xs pl-1">How it works</div>
                </div>
                <div className="bg-slate-200 rounded-full w-96 h-10 flex items-center">
                    ...
                    <form className="w-full">
                        <input type="text" placeholder="Search features, tutorials, etc." className="bg-inherit w-full focus:outline-none"/>
                    </form>
                </div>
                <div className="flex justify-end mr-4 ml-auto gap-4">
                    <div className="rounded-full w-10 h-10 flex items-center justify-center bg-slate-200"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" class="size-5">
